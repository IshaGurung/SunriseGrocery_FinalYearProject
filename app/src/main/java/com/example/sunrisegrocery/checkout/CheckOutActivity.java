package com.example.sunrisegrocery.checkout;
...
import com.example.sunrisegrocery.checkout.address.AddressActivity;
import com.example.sunrisegrocery.checkout.orderCompleted.OrderCompleteActivity;
...
public class CheckOutActivity extends AppCompatActivity {
    ...
    private void khaltiCheckOut() {
        ...
        Config.Builder builder = new Config.Builder("test_public_key_f22ed24f7ae24252af0472896359b913", "" + products.get(0).getId(), products.get(0).getName(), (long) (subTotalPrice + shippingCharge) * 100, new OnCheckOutListener(){
